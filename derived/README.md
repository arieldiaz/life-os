# derived/ — disposable understanding

Everything here is generated from `stream/` and can be regenerated. Delete freely.

Every derived file starts with a provenance header so `/rederive` knows what it's replacing:

```markdown
---
derived_from: stream/2026/07/05/0930-call-with-sam.m4a
derived_at: 2026-07-05
derived_by: <model or tool>
derived_where: local | cloud
